...
<section class="table-sec pt-3">
    <div class="container px-2 px-md-5">
        <div class="align-items-start border-bottom flex-column">
            <x-googleformsmodule::first-head label="Students table" icon="table" />
            ...
            <div class="container">
                <div class="card-body">
                    ...
                    <x-googleformsmodule::modal modalId="deleteModal{{ $student->id }}"
                        ...
                        modalTitle="Delete {{$student->user_email}}">
                        @method('DELETE')
                        <label class="form-label text-1000 fs-0 ps-0 text-capitalize lh-sm mb-2" for="adminTitle"> Are
                            You Sure ? </label>
                    </x-googleformsmodule::modal>
                    @endforeach
             ...
             <div class="modal fade " id="exportModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <form id="exportModalForm"  method="GET" action="{{ route('studentForm.selectedExport') }}">
                            @csrf
